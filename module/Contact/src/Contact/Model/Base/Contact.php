 ...
 *
 *
 * @package    propel.generator.Contact.Model.Base
 */
abstract class Contact implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Contact\\Model\\Map\\ContactTableMap';
    ...
    /**
     * Initializes internal state of Contact\Model\Base\Contact object.
     */
     ...
     * @return $this|\Contact\Model\Contact The current object (for fluent API support)
     */
    ...
    public function setPrenom($v)
    {
        ...
        if ($this->prenom !== $v) {
            $this->prenom = $v;
            $this->modifiedColumns[ContactTableMap::COL_PRENOM] = true;
        }
    ...
    public function setPhoto($v)
    {
        ...
        if ($this->photo !== $v) {
            $this->photo = $v;
            $this->modifiedColumns[ContactTableMap::COL_PHOTO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ContactTableMap::translateFieldName('Prenom', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $this->telephone = (null !== $col) ? (int) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ContactTableMap::translateFieldName('Photo', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Contact\\Model\\Contact'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ContactTableMap::COL_PRENOM)) {
        ...
        if ($this->isColumnModified(ContactTableMap::COL_PHOTO)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'prenom':
                        ...
                        break;
                    case 'telephone':
                        $stmt->bindValue($identifier, $this->telephone, PDO::PARAM_INT);
                        break;
                    case 'email':
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Contact\Model\Contact
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Contact\Model\Contact The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContactTableMap::COL_PRENOM)) {
            $criteria->add(ContactTableMap::COL_PRENOM, $this->prenom);
        }
        if ($this->isColumnModified(ContactTableMap::COL_TELEPHONE)) {
        ...
        if ($this->isColumnModified(ContactTableMap::COL_PHOTO)) {
            $criteria->add(ContactTableMap::COL_PHOTO, $this->photo);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Contact\Model\Contact (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Contact\Model\Contact Clone of current object.
     * @throws PropelException
     */
