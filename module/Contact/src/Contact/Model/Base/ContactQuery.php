...
namespace Contact\Model\Base;

use \Exception;
use \PDO;
use Contact\Model\Contact as ChildContact;
use Contact\Model\ContactQuery as ChildContactQuery;
use Contact\Model\Map\ContactTableMap;
 ...
 * @method     ChildContactQuery orderByPrenom($order = Criteria::ASC) Order by the prenom column
 ...
 * @method     ChildContactQuery orderByPhoto($order = Criteria::ASC) Order by the photo column
 *
 * @method     ChildContactQuery groupById() Group by the id column
 * @method     ChildContactQuery groupByNom() Group by the nom column
 * @method     ChildContactQuery groupByPrenom() Group by the prenom column
 ...
 * @method     ChildContactQuery groupByPhoto() Group by the photo column
 *
 ...
 * @method     ChildContact findOneByPrenom(string $prenom) Return the first ChildContact filtered by the prenom column
 * @method     ChildContact findOneByTelephone(int $telephone) Return the first ChildContact filtered by the telephone column
 * @method     ChildContact findOneByEmail(string $email) Return the first ChildContact filtered by the email column
 * @method     ChildContact findOneByPhoto(string $photo) Return the first ChildContact filtered by the photo column *
 ...
 * @method     ChildContact requireOneByPrenom(string $prenom) Return the first ChildContact filtered by the prenom column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildContact requireOneByTelephone(int $telephone) Return the first ChildContact filtered by the telephone column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildContact requireOneByPhoto(string $photo) Return the first ChildContact filtered by the photo column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildContact[]|ObjectCollection findByPrenom(string $prenom) Return ChildContact objects filtered by the prenom column
 * @method     ChildContact[]|ObjectCollection findByTelephone(int $telephone) Return ChildContact objects filtered by the telephone column
 * @method     ChildContact[]|ObjectCollection findByEmail(string $email) Return ChildContact objects filtered by the email column
 * @method     ChildContact[]|ObjectCollection findByPhoto(string $photo) Return ChildContact objects filtered by the photo column
...
abstract class ContactQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Contact\Model\Base\ContactQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'contacts', $modelName = '\\Contact\\Model\\Contact', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, nom, prenom, telephone, email, photo FROM contact WHERE id = :p0';
        try {
    ...
    public function filterByPrenom($prenom = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ContactTableMap::COL_PRENOM, $prenom, $comparison);
    }
     ...
     * Example usage:
     * <code>
     * $query->filterByTelephone(1234); // WHERE telephone = 1234
     * $query->filterByTelephone(array(12, 34)); // WHERE telephone IN (12, 34)
     * $query->filterByTelephone(array('min' => 12)); // WHERE telephone > 12
     * </code>
     *
     * @param     mixed $telephone The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
    ...
    public function filterByTelephone($telephone = null, $comparison = null)
    {
        if (is_array($telephone)) {
            $useMinMax = false;
            if (isset($telephone['min'])) {
                $this->addUsingAlias(ContactTableMap::COL_TELEPHONE, $telephone['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($telephone['max'])) {
                $this->addUsingAlias(ContactTableMap::COL_TELEPHONE, $telephone['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByPhoto($photo = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ContactTableMap::COL_PHOTO, $photo, $comparison);
    }
