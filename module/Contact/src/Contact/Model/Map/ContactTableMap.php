...
class ContactTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Contact.Model.Map.ContactTableMap';
     ...
     */
    const OM_CLASS = '\\Contact\\Model\\Contact';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Contact.Model.Contact';
     ...
     */
    const COL_NOM = 'contact.nom';

    /**
     * the column name for the prenom field
     */
    const COL_PRENOM = 'contact.prenom';

    /**
     * the column name for the telephone field
     */
    const COL_TELEPHONE = 'contact.telephone';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Nom', 'Prenom', 'Telephone', 'Email', 'Photo', ),
        self::TYPE_CAMELNAME     => array('id', 'nom', 'prenom', 'telephone', 'email', 'photo', ),
        self::TYPE_COLNAME       => array(ContactTableMap::COL_ID, ContactTableMap::COL_NOM, ContactTableMap::COL_PRENOM, ContactTableMap::COL_TELEPHONE, ContactTableMap::COL_EMAIL, ContactTableMap::COL_PHOTO, ),
        self::TYPE_FIELDNAME     => array('id', 'nom', 'prenom', 'telephone', 'email', 'photo', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Nom' => 1, 'Prenom' => 2, 'Telephone' => 3, 'Email' => 4, 'Photo' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'nom' => 1, 'prenom' => 2, 'telephone' => 3, 'email' => 4, 'photo' => 5, ),
        self::TYPE_COLNAME       => array(ContactTableMap::COL_ID => 0, ContactTableMap::COL_NOM => 1, ContactTableMap::COL_PRENOM => 2, ContactTableMap::COL_TELEPHONE => 3, ContactTableMap::COL_EMAIL => 4, ContactTableMap::COL_PHOTO => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'nom' => 1, 'prenom' => 2, 'telephone' => 3, 'email' => 4, 'photo' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Contact\\Model\\Contact');
        $this->setPackage('Contact.Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('nom', 'Nom', 'VARCHAR', true, 55, null);
        $this->addColumn('prenom', 'Prenom', 'VARCHAR', true, 50, null);
        $this->addColumn('telephone', 'Telephone', 'INTEGER', false, null, null);
        $this->addColumn('email', 'Email', 'VARCHAR', true, 100, null);
        $this->addColumn('photo', 'Photo', 'VARCHAR', false, 100, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ContactTableMap::COL_NOM);
            $criteria->addSelectColumn(ContactTableMap::COL_PRENOM);
            $criteria->addSelectColumn(ContactTableMap::COL_TELEPHONE);
            $criteria->addSelectColumn(ContactTableMap::COL_EMAIL);
            $criteria->addSelectColumn(ContactTableMap::COL_PHOTO);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Contact\Model\Contact) { // it's a model object
